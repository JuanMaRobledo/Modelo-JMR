...
function unauthorized() {
  return new Response("Usuario o contraseña incorrectos.", {
    ...
    headers: {
      ...
      "WWW-Authenticate": 'Basic realm="Modelo JMR", charset="UTF-8"'
    }
  });
}
...
export default function proxy(request) {
  ...
  // Nunca dejar el sitio abierto por un error de configuración en producción.
  ...
  // Esta cookie solo evita que la interfaz pida las credenciales dos veces.
  // El proxy vuelve a validar Basic Auth en cada recurso solicitado.
  return next({
    headers: {
