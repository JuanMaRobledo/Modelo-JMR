...
| `docs/screener.html` + `docs/screener/resultados.json` + `api/quotes.js` | Screener de "empresas maravillosas": filtros duros, puntaje de calidad 0-100, los múltiplos del Modelo JMR + PEG vs su propia historia; precios en vivo al abrir y exportación a Excel/CSV | Primer filtro antes del checklist de 8 pasos. Los fundamentales los recalcula todos los días hábiles `.github/workflows/screener.yml` con el motor de JMR-valuation |
