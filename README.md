...
| `docs/screener.html` + `docs/screener/resultados.json` | Screener de "empresas maravillosas": filtros duros (ROIC, FCF, deuda neta/EBITDA, ventas) + puntaje de calidad 0-100 + precio de hoy vs su propia historia (P/FCF, P/E) | Primer filtro para encontrar candidatas antes de aplicar el checklist de 8 pasos. Los resultados los genera `scripts/run_screener.py` en JMR-valuation (ver su README) |
